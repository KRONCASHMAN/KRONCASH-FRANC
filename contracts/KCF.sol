...
contract KronletCashFrancToken is ERC20 {
    ...
    string public tokenName = "Kronlet Cash Franc";
    string public tokenSymbol = "KCF";
    uint256 public tokenTotalSupply = 10_000_000_000 * 10**18;

    address public owner; // owner address

    address payable public CommunityAddress; // 0xd0d725208fd36BE1561050Fc1DD6a651d7eA7C89
    address payable public ReserveAddress; // 0xd0d725208fd36BE1561050Fc1DD6a651d7eA7C89
    address payable public TeamWalletAddress; // 0xd0d725208fd36BE1561050Fc1DD6a651d7eA7C89
    address payable public VestingContractAddress; // 0xd0d725208fd36BE1561050Fc1DD6a651d7eA7C89
    ...
    ///////////////////////////
    // setting functions by onwer 0xd0d725208fd36BE1561050Fc1DD6a651d7eA7C89
    /////////////////////////// 
    function setCommunityAddress(address _newCommunityAddr) external onlyOwner {
        CommunityAddress = payable(_newCommunityAddr);
    }

    function setReserveAddress(address _newReserveAddr) external onlyOwner {
        ReserveAddress = payable(_newReserveAddr);
    }

    function setTeamWalletAddress(address _newTeamWalletAddr) external onlyOwner {
        TeamWalletAddress = payable(_newTeamWalletAddr);
    }

    function setVestingContractAddress(address _newVestingAddr) external onlyOwner {
        VestingContractAddress = payable(_newVestingAddr);
    }
