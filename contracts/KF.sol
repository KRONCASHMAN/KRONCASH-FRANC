...
contract KronletFrancToken is ERC20 {
    ...
    string public tokenName = "Kronlet Franc";
    string public tokenSymbol = "KF";    
    ...
    address payable public VestingContractAddress;

    constructor() ERC20(tokenName, tokenSymbol) {
        inflationRate = 13; // Example inflation rate of 13% per year
