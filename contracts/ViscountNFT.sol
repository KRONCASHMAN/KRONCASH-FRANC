...
contract ViscountNFT is ERC721Enumerable, Ownable {
    ...
    KCFToken public TokenContract;
    bool public breedStart = false;
    uint256 public breedPrice = 1000 ether;

    constructor(string memory baseURI, address _fundWallet) ERC721("Viscount", "Viscount")  {
        require(_fundWallet != address(0), "Zero address error");
        setBaseURI(baseURI);
        fundWallet = _fundWallet;
    }
    
    function setKCFToken (KCFToken _TokenContract) public onlyOwner{
        // require(_TokenContract != address(0), "Contract address can't be zero address");
        TokenContract = _TokenContract;
    }
    
    function getKCFToken(address __address) public view returns(uint256) {
